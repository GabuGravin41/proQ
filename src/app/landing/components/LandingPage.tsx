    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <section className="relative overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-28 border-b border-border bg-gradient-to-b from-primary/5 via-transparent to-transparent">
        <div className="max-w-6xl mx-auto px-4 lg:px-8 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-muted/60 border border-border text-xs text-foreground font-medium mb-6">
            ...
            <span>2,000+ Verified Public Tenders</span>
            <span className="text-muted-foreground">•</span>
            <span className="font-semibold text-primary">KES 95.1B Pipeline</span>
            <span className="text-muted-foreground">•</span>
      ...
      <section className="border-b border-border bg-card py-8">
        <div className="max-w-6xl mx-auto px-4 lg:px-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <p className="text-3xl font-extrabold text-primary font-tabular">2,000+</p>
            <p className="text-xs text-muted-foreground mt-1">Verified Active Tenders</p>
          </div>
          <div>
            <p className="text-3xl font-extrabold text-foreground font-tabular">KES 95.1B</p>
            <p className="text-xs text-muted-foreground mt-1">Total Pipeline Value</p>
          </div>
          <div>
            <p className="text-3xl font-extrabold text-emerald-600 font-tabular">974 Lots</p>
